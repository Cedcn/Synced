...
RSpec.describe Authorization, type: :model do
  describe 'validation' do
    ...
    it 'can be destroied if user has two authorizations' do
      user2 = create(:user, :without_validation, :with_wechat_authorization, :with_weibo_authorization)
      expect(user2.authorizations.first.destroy).not_to be_falsy
    end
  end
end
